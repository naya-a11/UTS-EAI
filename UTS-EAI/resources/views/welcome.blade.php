            ...
            <div class="carousel-item active" style="background-image: url('{{ asset('images/movies/pabrik-gula.jpg') }}');">
                <div class="container">
                    <div class="carousel-caption text-start">
                        ...
                        <p><a class="book-now-btn" href="#">Book Now</a></p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="movie-card">
                        ...
                        <div class="movie-info">
                            ...
                            <a href="#" class="book-now-btn w-100 text-center">Book Now</a>
                        </div>
                    </div>
                </div>
                <!-- Movie 2 -->
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="movie-card">
                        ...
                        <div class="movie-info">
                            ...
                            <a href="#" class="book-now-btn w-100 text-center">Pre-Book Now</a>
                        </div>
                    </div>
                </div>
                <!-- Movie 2 -->
