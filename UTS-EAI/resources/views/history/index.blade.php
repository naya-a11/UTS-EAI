        ...
        <div class="card">
            <div class="card-body">
                <h1 class="card-title h3 mb-4 text-center">
                    <i class="fas fa-history text-primary me-2"></i>History Pembelian
                </h1>

                @if($bookings->isEmpty())
                    <div class="text-center py-5">
                        <i class="fas fa-ticket-alt text-muted" style="font-size: 4rem;"></i>
                        <h3 class="mt-3">Belum Ada Pembelian</h3>
                        <p class="text-muted">Anda belum melakukan pembelian tiket film.</p>
                        <a href="{{ route('movies.index') }}" class="btn btn-primary">
                            <i class="fas fa-film me-2"></i>Tonton Film
                        </a>
                    </div>
                @else
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-muted mb-1">
                                        ...
                                        {{ $booking->schedule->show_time->format('l, d M Y') }}
                                    </p>
                                    <p class="text-muted mb-1">
                                        <i class="fas fa-clock me-2"></i>
                                        {{ $booking->schedule->show_time->format('H:i') }}
                                    </p>
                                    <p class="text-muted mb-1">
